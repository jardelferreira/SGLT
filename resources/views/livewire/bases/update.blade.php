    ...
    <div class="modal-dialog" role="document">
       <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Editar Base</h5>
            ...
            <div class="modal-body">
                <form>
                    ...
                    <div class="form-group">
                        <input type="hidden" wire:model="uuid">
                        <label for="description_update">Descrição</label>
                        <input type="text" class="form-control" wire:model="description" id="description_update" placeholder="Enter Name">
                        @error('name') <span class="text-danger">{{ $message }}</span>@enderror
                    </div>
                </form>
            </div>
