...
<p class="mb-0"><i class="fas fa-tachometer-fastest    "></i>Cadastro de Funções 
    ...
    <button class="btn btn-success" wire:click="resetInputs()" data-toggle="modal" data-target="#createModal">Cadastrar nova função</button>
</p>
    ...
    <table class="table table-striped bg-light mt-2 table-responsive">
        ...
        <tbody>
            ...
            <tr>
                ...
                <a href="{{route('dashboard.roles.permissions',$value->id)}}" class="btn btn-info">Permissões</a>
                </td>
            </tr>
            @endforeach
        </tbody>
