    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Cadastrar canteiros em <strong>{{$trecho->name}}</strong></h5>
           ...
           <div class="modal-body">
                <form>
                    ...
                    <div class="form-group">
                        <label for="location_create">Localização</label>
                        <input type="text" class="form-control" id="location_create" placeholder="Enter Name" wire:model.lazy="location">
