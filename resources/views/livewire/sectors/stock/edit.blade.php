    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editModalLabel">Cadastrar Material em <strong>{{$sector->name}}</strong></h5>
           ...
           <div class="modal-body">
            ...
            <div class="modal-footer">
                ...
                <button type="button" wire:click.prevent="addEstoque({{$stock_id}})" class="btn btn-success close-modal">Salvar</button>
            </div>
        </div>
    </div>
</div>